public class rajamantri extends Activity 
{
	...
	static String player1Name = "" ; //changed variable names
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        i=j=k=l=0; //initialized in single line instead of 4.
			...
			public void onClick(View v)
			 {
				...
				else
				{
					...
					playersArray[0] = player1Name;
			 		...
			 		playersArray[3] = player4Name; //removed unneccesary space
    ...
    public void makeGuess()
    {
		...
		//changed all if statements in if-else structure.As with if we have to check all if conditions but due to if-else after matching condition other 	        statements are skipped
		...
		else if(player2Role.equals("MANTRI"))
		{
			txtTurn.setText(player2Name + " will find the CHOR!");
		}
		else if(player3Role.equals("MANTRI"))
		{
			txtTurn.setText(player3Name + " will find the CHOR!");
		}
		else(player4Role.equals("MANTRI"))
		{
    ...
    public void shuffle()
    {
			...
			btnPod1.setOnClickListener(new OnClickListener() 
			{
				...
				public void onClick(View v) 
				{
					...
					if(txtTurn.getText().equals(player1Name + "'s" + " turn!")) 
					{
						...
						if(player1.equals("MANTRI")) //changed if statements to if-else structure
						{
							
							player1Role = "MANTRI";
						}
						else if(player1.equals("RAJA"))
						{
							
							player1Role = "RAJA";
						}
						else if(player1.equals("SIPAHI"))
						{

							player1Role = "SIPAHI";
						}
						else(player1.equals("CHOR"))
						{
			...
			btnPod2.setOnClickListener(new OnClickListener() 
			{
					...
					if(txtTurn.getText().equals(player1Name + "'s" + " turn!"))
					{
							...
							if(player2.equals("MANTRI")) //changed if statements to if-else structure
							{
							...
							else if(player2.equals("SIPAHI"))
							{

								player1Role = "SIPAHI";
							}
							else(player2.equals("CHOR"))
							{
			...
			btnPod3.setOnClickListener(new OnClickListener() {
					...
					if(txtTurn.getText().equals(player1Name + "'s" + " turn!"))
					{
							...
							if(player3.equals("MANTRI")) //changed if statements to if-else structure
							{
							...
							else if(player3.equals("SIPAHI"))
							{

								player1Role = "SIPAHI";
							}
							else(player3.equals("CHOR"))
							{
					...
					public void onClick(View v)
					 {
						...
						if(txtTurn.getText().equals(player1Name + "'s" + " turn!"))
						{
							...
							if(player4.equals("MANTRI")) //changed if statements to if-else structure
							{
								
								player1Role = "MANTRI";
							}
							else if(player4.equals("RAJA"))
							{
								
								player1Role = "RAJA";
							}
							else if(player4.equals("SIPAHI"))
							{

								player1Role = "SIPAHI";
							}
							else (player4.equals("CHOR"))
							{
